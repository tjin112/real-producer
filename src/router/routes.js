...
import PropertyDetail from "../views/propertyManagement/propertyDetail";
export default [Index, Search, Login, Register, Orders, Me, CustomerInfo,AddContact,tagsearch,addShowing,addAppointment,openHouse,openHouseDetail,List,Leads,AddEvent,customerList,PropertyDetail];
